...
const photoCapabilities = imageCapture.getPhotoCapabilities().then(() => {
      ...
      } document.getElementById('torchOnButton').addEventListener('click', turnOnTorch);
document.getElementById('torchOffButton').addEventListener('click', turnOffTorch);
  });
}
